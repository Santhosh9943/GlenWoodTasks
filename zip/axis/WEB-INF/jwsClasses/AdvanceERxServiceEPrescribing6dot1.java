...
public class AdvanceERxServiceEPrescribing6dot1 extends BCodec {
    String server;
    String database;
    String user;
    String pass;

    public AdvanceERxServiceEPrescribing6dot1() {
    ...
    public String sendTransaction( String urlString,  String transaction,  boolean isXML)
        ...
        try {
            ...
            if (isXML) {
				url = new URL("https://smh.surescripts.net/medhistory/Glenwood6/mhv3_0?id=" + messageId);
			} else {
				url = new URL("https://smr.surescripts.net/erx/Glenwood6/v6_1?id=" + messageId);
			}

            logStep("calling webservice "+url);
             HttpsURLConnection con = (HttpsURLConnection) url.openConnection();
             KeyStore trustStore = KeyStore.getInstance("JKS");
            trustStore.load(new FileInputStream("/usr/java/jdk1.8.0_65/jre/lib/security/cacerts"),
