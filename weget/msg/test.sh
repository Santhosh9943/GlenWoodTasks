...
tail -n +2 data.csv | while read line; do
    ...
    echo "curl -X POST https://api.twilio.com/2010-04-01/Accounts/AC2a1d2545d7c4388bce7f8cebf8bb5641/Messages.json \\\n"
        		+ "--data-urlencode \"To=+1" + toNumber + "\" \\"+"\n"
        		+ "--data-urlencode \"From=+15613635561\" \\\n"
        		+ "--data-urlencode \"Body=You have an outstanding balance of $ "+balance+" with Allergy Consultant Inc.To make a payment via Phone or if you have any questions, Please call us at 5613687006. Reply STOP to optout.\" \\\n"
